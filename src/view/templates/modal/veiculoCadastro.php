    ...
    <div class="modal-content">
      ...
      <form action="Fornecedor.php" method="post">
        <div class="modal-body">
          ...
          <div class="form-row mt-3">
            <div class="col">
              <input type="text" class="form-control" placeholder="Setor" id="setorEditar" name="dcrsetor">
            </div>
      
            <div class="col">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="garagem" value="garagem" id="checkGaragemEditar">
          ...
          <div class="form-row mt-3">
            <div class="col">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="fornecedor" value="fornecedor" id="checkFornecedorEditar">
