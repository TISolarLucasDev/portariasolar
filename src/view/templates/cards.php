    ...
    <div class="card card-1">
      <div class="card-body">
        <form action="buscarVeiculos.php" method="post">
          ...
          <button><img draggable="false" src="images/icons/search.png" alt="Buscar"></button>
        </form>
            ...
            <div class="continer-card ">
              <div class="row">
                 ...
                 <div class="buttonContainer">
                  <a href="#"  class="btn btn-success" id="entrar"><i class="bi bi-box-arrow-in-left"></i> Autorizar Entrada</a>
