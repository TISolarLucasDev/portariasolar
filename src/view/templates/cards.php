        ...
        <div class="card card-1">
            <div class="card-body">
                <form action="buscarVeiculos.php" method="post">
                    <input type="text" name="placa" id="inputPlacas" placeholder="Digite a placa para a pesquisa"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="card-item-1">
                                    ...
                                    <p><?= isset($placas[0][4]) ? "{$placas[0][4]}  - " : ' Informações do veículo' ?>
                                    </p>
                            ...
                            <div class="col-md-6">
                                <div class="card-item-1">
                                    <img draggable="false"
                                        src="<?= isset($placas[0][3]) == "S" ? '/images/icons/ok.png' : '/images/icons/cancel.png' ?>"
                                        alt="Acesso ao estacionamento?">
                                    <p><?= isset($placas[0][3]) == "S" ? 'Acesso permitido ao estacionamento' : ' Acesso não permitido ao estacionamento' ?>
                                    </p>
                                </div>
                                ...
                                <div class="buttonContainer">
                                    <button type="button" class="btn btn-success" id="entrar" data-toggle="modal"
                                        data-target="#modalEntrada"
                                        <?php if(in_array($placas[0][1], $placasVeiculosDentro)) { ?> disabled
                                        <?php }; ?>><i class="bi bi-box-arrow-in-left"></i> Autorizar Entrada</button>
                                    <button type="button" class="btn btn-danger" id="sair"
                                        onclick="exibeModalSaida(<?php echo $acaoModalSaida ?>)"
                                        <?php if(!in_array($placas[0][1], $placasVeiculosDentro)) { ?> disabled
                                        <?php }; ?>><i class="bi bi-box-arrow-right"></i> Autorizar Saida</button>
                                </div>
                            </div>
                        </div>
                    </div>
